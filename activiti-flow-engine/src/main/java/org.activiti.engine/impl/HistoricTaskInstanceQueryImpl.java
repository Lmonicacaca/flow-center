...
public class HistoricTaskInstanceQueryImpl extends AbstractVariableQueryImpl<HistoricTaskInstanceQuery, HistoricTaskInstance> implements HistoricTaskInstanceQuery {
  ...
  @Override
  public HistoricTaskInstanceQuery taskStatus(List<String> taskStatus) {
    if (taskStatus == null || taskStatus.isEmpty()) {
      throw new ActivitiIllegalArgumentException("taskStatus list is null or empty.");
    }

    if (inOrStatement) {
      this.currentOrQueryObject.taskStatus = taskStatus;
    } else {
