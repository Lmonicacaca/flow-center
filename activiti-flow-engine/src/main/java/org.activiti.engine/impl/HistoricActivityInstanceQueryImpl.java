...
public class HistoricActivityInstanceQueryImpl extends AbstractQuery<HistoricActivityInstanceQuery, HistoricActivityInstance> implements HistoricActivityInstanceQuery {
  ...
  protected List<String> processInstanceId;
  protected String executionId;
  protected String processDefinitionId;
  protected String activityId;
  protected String activityName;
  protected List<String> activityType;
  protected List<String> taskStatus;
  ...
  protected boolean processDefinitionIdLikeTag;
  ...
  @Override
  public HistoricActivityInstanceQueryImpl processInstanceIdIn(List<String> processInstanceId) {
  ...
  @Override
  public HistoricActivityInstanceQuery startTimeBefore(Date date) {
    this.before = date;
    return this;
  }

  @Override
  public HistoricActivityInstanceQuery startTimeAfter(Date date) {
    this.after = date;
    return this;
  }
  ...
  @Override
  public HistoricActivityInstanceQueryImpl processDefinitionIdLike(String processDefinitionId) {
    this.processDefinitionIdLikeTag = true;
    this.processDefinitionId = processDefinitionId;
    return this;
  }
  ...
  public HistoricActivityInstanceQueryImpl activityType(List<String> activityType) {
    this.activityType = activityType;
    return this;
  }

  @Override
  public HistoricActivityInstanceQuery taskStatus(List<String> taskStatus) {
  ...
  public HistoricActivityInstanceQueryImpl orderByActivityId() {
  ...
  public boolean isProcessDefinitionIdLikeTag() {
    return processDefinitionIdLikeTag;
  }
