...
import org.activiti.engine.delegate.event.listener.TaskCompletedEventListener;
  ...
  */
  ...
  public void initEventDispatcher() {
    ...
    this.eventDispatcher.setEnabled(enableEventDispatcher);
      ...
      TaskCompletedEventListener taskCompletedEventListener = new TaskCompletedEventListener(historyManager);
      this.eventDispatcher.addEventListener(taskCompletedEventListener, ActivitiEventType.TASK_COMPLETED);
