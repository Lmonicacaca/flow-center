...
public class MybatisHistoricActivityInstanceDataManager extends AbstractDataManager<HistoricActivityInstanceEntity> implements HistoricActivityInstanceDataManager {
  ...
  @Override
  public List<HistoricActivityInstanceEntity> findHistoricActivityInstancesByTaskIdAndProcessInstanceId(String taskId, String processInstanceId) {
    Map<String, Object> params = new HashMap<String, Object>();
    params.put("taskId", taskId);
    params.put("processInstanceId", processInstanceId);
    return getList("findUnfinishedHistoricActivityInstancesByTaskIdAndProcessInstanceId",params, unfinishedHistoricActivityInstanceMatcher, true);
  }
  ...
  public void deleteHistoricActivityInstancesById(String id) {
    getDbSqlSession().delete("deleteHistoricActivityInstance", id, HistoricActivityInstanceEntityImpl.class);
  }
  @Override
