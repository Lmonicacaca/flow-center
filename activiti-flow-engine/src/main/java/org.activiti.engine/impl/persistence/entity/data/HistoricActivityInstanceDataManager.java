...
public interface HistoricActivityInstanceDataManager extends DataManager<HistoricActivityInstanceEntity> {
  ...
  List<HistoricActivityInstanceEntity> findHistoricActivityInstancesByTaskIdAndProcessInstanceId(String taskId,String processInstanceId);
  ...
  void deleteHistoricActivityInstancesById(String id);
