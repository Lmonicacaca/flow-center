...
public class TaskServiceImpl extends ServiceImpl implements TaskService {
  ...
  public Comment addComment(String taskId, String message) {
    return commandExecutor.execute(new AddCommentCmd(taskId, message));
  }

  public Comment addComment(String taskId,String type, String message) {
    return commandExecutor.execute(new AddCommentCmd(taskId, type, message));
  }
