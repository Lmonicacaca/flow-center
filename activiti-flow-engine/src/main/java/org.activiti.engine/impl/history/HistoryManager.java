...
public interface HistoryManager {
  ...
  void recordProcessInstanceEnd(String processInstanceId,String approvalStatus);
  ...
  void recordActivityStart(ExecutionEntity executionEntity,FlowElement flowElement);
  /**
   ...
   * @param taskStatus
   */
  void recordTaskStatusChange(String taskId, String taskStatus);
   ...
   */
  void recordProcessStatusChange(String processInstanceId, String approvalStatus);
  /**
