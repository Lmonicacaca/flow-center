...
public interface HistoricActivityInstanceQuery extends Query<HistoricActivityInstanceQuery, HistoricActivityInstance> {
   ...
   */
  HistoricActivityInstanceQuery processInstanceIdIn(List<String> processInstanceId);
  ...
  HistoricActivityInstanceQuery processDefinitionIdLike(String processDefinitionId);
  ...
  HistoricActivityInstanceQuery startTimeBefore(Date date);


  HistoricActivityInstanceQuery startTimeAfter(Date date);
  /**
   ...
   */
  HistoricActivityInstanceQuery activityType(List<String> activityType);

  HistoricActivityInstanceQuery taskStatus(List<String> taskStatus);
